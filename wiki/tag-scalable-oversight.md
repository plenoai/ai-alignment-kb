# tag: scalable-oversight

AI エージェントに対する人間の監視（Oversight）を、品質を落とさずスケールさせることに関するコンテンツ。
...
- [OpenAI — AI による未知のミスアライメント発見](./openai-ai-discovered-unknowns-case.md)
